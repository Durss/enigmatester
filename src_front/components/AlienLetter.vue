<template>
	<div class="alienletter">
		<svg viewBox="0 0 101.5 109.3" v-if="value == 0">
		...
		<svg viewBox="0 0 101.8 108.1" v-if="value == 1">
		...
		<svg viewBox="0 0 116.5 105.6" v-if="value == 2">
		...
		<svg viewBox="0 0 92.2 98.7" v-if="value == 3">
		...
		<svg viewBox="0 0 101.7 112.1" v-if="value == 4">
		...
		<svg viewBox="0 0 118.5 109.2" v-if="value==5">
		...
		<svg viewBox="0 0 120.4 93.4" v-if="value==6">
		...
		<svg viewBox="0 0 103.1 98.6" v-if="value == 7">
		...
		<svg viewBox="0 0 109.6 105" v-if="value==8">
		...
		<svg viewBox="0 0 124.9 103.5" v-if="value == 9">
...
import { MorphSVGPlugin, TimelineMax, TweenLite, Linear } from 'gsap/all';
